# Important
This is a slightly altered version of the [terraform-aws-instance](https://github.com/terraform-aws-modules/terraform-aws-ec2-instance) resource.
Above the original functionallity it offers one additional input.
* name_array - an array of names to use for the instances

This repo is based on the 1.21.0 tag of the terraform-aws-instance repo tag
